...
@Component({
  ...
  template: `<div
      ...
      [class.-top-12]="!notificationService.showNotification()"
      [class.top-8]="notificationService.showNotification()"
      [class.scale-100]="notificationService.showNotification()">
      <div class="rounded-lg w-64 flex bg-gris-50 dark:bg-gris-800 items-center gap-4 pl-2 py-3">
