...
@Component({
    ...
    template: `
        <div
            class="drawer  shadow-lg/60 dark:shadow-lg/70 md:shadow-none fixed md:top-14 top-0   z-14 dark:shadow-black shadow-black/80  bg-drawer bottom-0 overflow-hidden"
            [class.open]="isOpen()"
